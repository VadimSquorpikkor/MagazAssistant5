...
public class EmployeeDialog_old extends BaseDialog {


    private EmployeeDialog_old() {
    }
...
//    }
    ...
    public EmployeeDialog_old(Employee employee) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        initializeWithVM(R.layout.employee_order_old);
